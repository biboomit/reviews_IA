...
DEVELOPER_TOKEN='1458NRVF87140883'
...
authorization_data = AuthorizationData(
    account_id=None,  # Se asignará después de autenticarse
    customer_id=None,  # Se asignará después de autenticarse
    developer_token=DEVELOPER_TOKEN,  # Token de desarrollador de Bing Ads
    authentication=None  # Se asignará en authenticate_with_oauth()
)
...
# Llamar a authenticate DESPUÉS de definir todas las funciones
